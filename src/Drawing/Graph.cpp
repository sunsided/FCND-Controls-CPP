...
void Graph::AddAbsThreshold(string path) {
    ...
    shared_ptr<AbsThreshold> thr(
            new AbsThreshold(args[0], (float) atof(args[1].c_str()), (float) atof(args[2].c_str())));
...
void Graph::AddWindowThreshold(string path) {
    ...
    shared_ptr<WindowThreshold> thr(
            new WindowThreshold(args[0], (float) atof(args[1].c_str()), (float) atof(args[2].c_str())));
    _analyzers.push_back(thr);
}
