...
public:
    ...
    void VisualizeTrajectory(const Trajectory &traj, bool drawPoints, V3F color, float alpha = 1,
                             V3F pointColor = V3F(.1f, .2f, 1), V3F curPointColor = V3F(1, 0, 0), V3F offset = V3F(),
                             int style = 0);
